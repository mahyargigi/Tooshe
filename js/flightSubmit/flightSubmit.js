...
//    }
    ...
    $('#departure-city').geocomplete(acOptions).bind("geocode:result", function(event, click){
        ...
        $('#departure-city').closest('div').append('<span style="display: none;" class="location-span"><span style="display: none;"><input type="hidden" name="startpoint_city" value="'+String(city)+'"></span>'+
                '<span style="display: none;"><input type="hidden" name="startpoint_country" style="display: none;" value="'+String(country)+'"></span>'+
                '<span style="display: none;"><input type="hidden" name="startpoint_lat" style="display: none;" value="'+String(lat)+'"></span>'+
                '<span style="display: none;"><input type="hidden" name="startpoint_lng" style="display: none;" value="'+String(lng)+'"></span>'+
                '<span style="display: none;"><input type="hidden" name="startpoint_placeID" style="display: none;" value="'+String(place_id)+'"></span></span>');
    });
    ...
    $('#arrival-city').geocomplete(acOptions).bind("geocode:result", function(event, click){
        ...
        $('#arrival-city').closest('div').append('<span style="display: none;" class="location-span"><span style="display: none;"><input type="hidden" name="destination_city" value="'+String(city)+'"></span>'+
